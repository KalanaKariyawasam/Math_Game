def difficult():
    "This is for Difficult Game Mode"
...
#Get user inputs
    print("\n**NOTE : If it is a question of division please enter only QUOTIANT and disregard the remainder!\n")
...
#Process
    while(count<=int(qnum)):
        ...
        opr = random.choice(oplist)
        question = input("Q"+str(count)+": "+str(num1)+str(opr)+str(num2)+" = ")

        if(int(question) == (num1+num2) or int(question) == (num1-num2) or int(question) == (num1*num2) or int(question) == (num1**num2) or int(question) == (num1//num2)):
            if(opr == "+"):
                playerdetails.append(("Q"+str(count)+": "+str(num1)+str(opr)+str(num2)+" = "+str(question)+" (Correct Answer "+str(num1+num2)+")"+" Correct"))
            elif(opr == "-"):
                playerdetails.append(("Q"+str(count)+": "+str(num1)+str(opr)+str(num2)+" = "+str(question)+" (Correct Answer "+str(num1-num2)+")"+" Correct"))
            elif(opr == "*"):
                playerdetails.append(("Q"+str(count)+": "+str(num1)+str(opr)+str(num2)+" = "+str(question)+" (Correct Answer "+str(num1*num2)+")"+" Correct"))
            ...
            if(opr == "+"):
                playerdetails.append(("Q"+str(count)+": "+str(num1)+str(opr)+str(num2)+" = "+str(question)+" (Correct Answer "+str(num1+num2)+")"+" Incorrect"))
            elif(opr == "-"):
                playerdetails.append(("Q"+str(count)+": "+str(num1)+str(opr)+str(num2)+" = "+str(question)+" (Correct Answer "+str(num1-num2)+")"+" Incorrect"))
            elif(opr == "*"):
                playerdetails.append(("Q"+str(count)+": "+str(num1)+str(opr)+str(num2)+" = "+str(question)+" (Correct Answer "+str(num1*num2)+")"+" Incorrect"))
